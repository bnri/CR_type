...
export type RecordingStartEvent = ViewerEventBase<'recording_start', { snapshot: RecordingSnapshot }>;
export type RecordingStopEvent = ViewerEventBase<'recording_stop', { duration: number }>;
export type GlobalIndexChangeEvent = ViewerEventBase<'global_index_change', { globalIndex: number }>;
...
export type PageChangeEvent = ViewerEventBase<'page_change', { page: number }>;
...
export type SettingsChangeEvent = ViewerEventBase<'settings_change', { key: keyof CRViewerState; value: unknown }>;
export type ViewerStateSnapshotEvent = ViewerEventBase<'viewer_state_snapshot', { viewerState: CRViewerState }>;
...
export type ViewportResizeEvent = ViewerEventBase<'viewport_resize', { width: number; height: number }>;
