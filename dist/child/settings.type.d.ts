...
export declare const DEFAULT_CHILD_NOTIFICATION_SETTINGS: ChildNotificationSettings;
/** 자녀 설정 전체 평탄 표면 — DTO 평탄화 + 프론트 토글 SSOT */
export type ChildSettings = ChildRecommendationSettings & ChildViewerSettings & ChildNotificationSettings;
export declare const DEFAULT_CHILD_SETTINGS: ChildSettings;
